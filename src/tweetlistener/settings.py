# Django settings for tweetlistener project.
import os
import djcelery
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tweetlistener.db',                      # Or path to database file if using sqlite3.
...
WSGI_APPLICATION = 'tweetlistener.wsgi.application'
